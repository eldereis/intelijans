 ...
 */
public class BZipServletResponseWrapper extends HttpServletResponseWrapper {
    /**
     ...
     */
    public BZipServletResponseWrapper(HttpServletResponse response) {
        super(response);
    ...
    public ServletOutputStream createOutputStream() throws IOException {
        ...
        return (new BZipResponseStream(origResponse));
    }
    ...
    public void flushBuffer() throws IOException {
        ...
        ((BZipResponseStream) stream).flush();
    }
    ...
    public ServletOutputStream getOutputStream() throws IOException {
        ...
        ((BZipResponseStream) stream).setBuffer(threshold);
