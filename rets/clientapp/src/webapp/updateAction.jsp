<%-- $Header: /usr/local/cvsroot/rets/clientapp/src/webapp/updateAction.jsp,v 1.5 2005/04/08 14:18:54 ekovach Exp $ --%>
...
RETSUpdateValidator validator = new RETSUpdateValidator(request.getParameter("resource"), "ResidentialProperty", "Chg");
