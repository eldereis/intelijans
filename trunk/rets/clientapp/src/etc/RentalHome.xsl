...
<a><xsl:attribute name="href">searchAgentAction.jsp?searchQuery=%28AgentID%3D<xsl:value-of select="Listing/ListingData/REAgent/AgentID"/>%29&amp;QueryType=DMQL</xsl:attribute><xsl:value-of select="Listing/ListingData/REAgent/AgentID"/></a>
   ...
   <td>
    ...
    <a><xsl:attribute name="href">searchPropertyAction.jsp?searchQuery=%28PostalCode%3D<xsl:value-of select="Listing/StreetAddress/PostalCode"/>%29&amp;QueryType=DMQL&amp;searchLimit=20&amp;searchClass=RentalHome&amp;searchStandardNames=1</xsl:attribute><xsl:value-of select="Listing/StreetAddress/PostalCode"/></a>
