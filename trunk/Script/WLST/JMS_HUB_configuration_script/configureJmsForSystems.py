...
try:
  ...
  for line in fileLines:
    ...
    ireq = "attip.jms." + systemId + "." + systemId + "_to_aTTIP_request"
    ires = "attip.jms." + systemId + "." + systemId + "_to_aTTIP_response"
    oreq = "attip.jms." + systemId + ".aTTIP_to_" + systemId + "_request"
    ores = "attip.jms." + systemId + ".aTTIP_to_" + systemId + "_response"
